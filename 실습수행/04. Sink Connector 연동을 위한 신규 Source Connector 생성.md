...
insert into customers values (3, 'testaddress_02@testdomain', 'testuser_03', now());
insert into customers values (4, 'testaddress_02@testdomain', 'testuser_04', now());
insert into customers values (5, 'testaddress_02@testdomain', 'testuser_05', now());

insert into orders values(1, now(), 1, 'delivered', 1, now());
insert into orders values(2, now(), 2, 'delivered', 2, now());
insert into orders values(3, now(), 3, 'delivered', 3, now());
insert into orders values(4, now(), 4, 'delivered', 4, now());
insert into orders values(5, now(), 5, 'delivered', 5, now());

insert into products values(1, 'testproduct', 'testcategory', 100, now());
insert into products values(2, 'testproduct', 'testcategory', 200, now());
insert into products values(3, 'testproduct', 'testcategory', 300, now());
insert into products values(4, 'testproduct', 'testcategory', 400, now());
insert into products values(5, 'testproduct', 'testcategory', 500, now());

insert into order_items values(1, 1, 1, 100, 1, now());
insert into order_items values(2, 2, 2, 200, 2, now());
insert into order_items values(3, 3, 3, 300, 3, now());
insert into order_items values(4, 4, 4, 400, 4, now());
insert into order_items values(5, 5, 5, 500, 5, now());
```
...
- mysql_jdbc_source_customers_01.json
```
{
    "name": "mysql_jdbc_source_customers",
    "config": {
...
- mysql_jdbc_source_order_items_02.json
```
{
    "name": "mysql_jdbc_source_order_items",
    "config": {
...
- mysql_jdbc_source_orders_03.json
```
{
    "name": "mysql_jdbc_source_orders",
    "config": {
...
- mysql_jdbc_source_products_04.json
```
{
    "name": "mysql_jdbc_source_products",
    "config": {
